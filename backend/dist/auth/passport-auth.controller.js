...
const passport_local_guard_1 = require("./guard/passport-local.guard");
const passport_jwt_guard_1 = require("./guard/passport-jwt.guard");
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], PassportAuthController.prototype, "getUser", null);
